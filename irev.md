...
- Проверь, что **ставки заведены** (см. [Affiliate Payouts](https://example.com/irev/affiliate-payouts) и [Advertiser Revenue](https://example.com/irev/advertiser-revenue)).
...
См. также: [Manual Injections](https://example.com/irev/manual-injections)
...
1. Открываем `Leads` (см. [Leads](https://example.com/irev/leads))
...
- `Affiliate Payout` — сколько платим байеру (см. [Affiliate Payouts](https://example.com/irev/affiliate-payouts))
- `Advertiser Revenue` — сколько получаем от рекла (см. [Advertiser Revenue](https://example.com/irev/advertiser-revenue))
...
5. Открывают `Deal Updater` (см. [Deal Updater](https://example.com/irev/deal-updater))
6. Меняют ставку
7. `Approve`
...
1. Идём в `Rotation` (см. [Rotation Control](https://example.com/irev/rotation))
2. Выбираем GEO

# ОБУЧЕНИЕ iRev — операционная работа

1. Fit по лидам (разбор запросов байеров)
2. Дубли и как их проверять
3. CPL vs CPA/FTD — что где смотреть
4. Проверка через PP (Partner Panel)
5. Заведение ставок (Rates)
6. Обновление ставки задним числом
7. Открытие партнёра и нового GEO
